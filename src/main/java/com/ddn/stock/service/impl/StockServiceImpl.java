...
import com.ddn.stock.indicator.IndicatorAlgorithm;
...
public class StockServiceImpl implements StockService {
  ...
  @Override
  public void updateBasic(String stockCode, String description, String displayName) {
    mongoTemplate.updateFirst(query(where("code").is(stockCode)),
        update("description", description).set("displayName", displayName), Stock.class);
  }
  ...
  @Override
  public void appendDailyExchangeData(String stockCode, Exchange exchange) {
